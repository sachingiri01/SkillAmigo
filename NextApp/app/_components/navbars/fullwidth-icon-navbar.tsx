          ...
          <div className="flex items-center gap-3">
            {session ? (
              ...
              <Button
                ...
                className="bg-transparent border-jet-stream-400/40 text-white hover:bg-saffron hover:border-saffron hover:text-white hover:scale-105 hover:shadow-[0_0_20px_rgba(230,126,34,0.4)] transition-all duration-300 cursor-pointer"
              >
                <a className="flex items-center gap-2">
                  <svg
                    className="w-4 h-4 transition-transform duration-200 group-hover:rotate-12"
