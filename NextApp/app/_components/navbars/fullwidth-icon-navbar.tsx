...
//                 key={item.title}
//                 href={item.url}
//                 className="text-sm font-medium text-white hover:text-saffron transition-colors duration-200 hover:drop-shadow-[0_0_8px_rgba(230,126,34,0.6)]"
//               >
//                 {item.title}
//               </a>
//             ))}
...
//               variant="outline" 
//               size="sm"
//               className="bg-transparent border-jet-stream-400/40 text-white hover:bg-saffron hover:border-saffron hover:text-white hover:drop-shadow-[0_0_12px_rgba(230,126,34,0.4)] transition-all duration-200"
//             >
...
//               asChild 
//               size="sm"
//               className="bg-saffron hover:bg-saffron/90 text-white hover:drop-shadow-[0_0_16px_rgba(230,126,34,0.6)] transition-all duration-200"
//             >
//               <a href="/auth/facebook" className="flex items-center gap-2">
...
//                 <Button variant="outline" size="icon" className="bg-transparent border-jet-stream-400/40 text-white hover:bg-jet-stream-400/20">
...
//                         key={item.title} 
//                         href={item.url} 
//                         className="text-md font-semibold text-white hover:text-saffron transition-colors"
//                       >
//                         {item.title}
//                       </a>
//                     ))}
...
//                       asChild 
//                       variant="outline"
//                       className="bg-transparent border-jet-stream-400/40 text-white hover:bg-saffron hover:border-saffron hover:text-white"
//                     >
//                       <a href="/auth/google" className="flex items-center gap-2">
//                         <svg className="w-4 h-4" viewBox="0 0 24 24">
//                           <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden lg:flex justify-between items-center py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <a href="/auth/facebook" className="flex items-center gap-2 group">
                <Facebook className="w-4 h-4 transition-transform duration-200 group-hover:rotate-12" />
        ...
        <div className="flex md:hidden items-center justify-between py-3">
          ...
          >
            ...
            <span className="text-lg font-display font-semibold tracking-tight text-white group-hover:text-saffron transition-colors duration-200">
              SkillAmigo
            </span>
          </a>
