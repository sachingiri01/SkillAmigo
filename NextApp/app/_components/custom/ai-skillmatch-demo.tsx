...
//     <div className="bg-jet-stream-975 py-24">
...
//                               className="bg-jet-stream-975 border border-jet-stream-400/20 rounded-lg p-4 hover:border-saffron/30 transition-colors cursor-pointer group"
//                             >
...
//                               : "bg-jet-stream-975 text-white border border-jet-stream-400/20"
//                           }`}
//                         >
...
//                       <Bot className="w-4 h-4 text-white" />
//                     </div>
//                     <div className="bg-jet-stream-975 border border-jet-stream-400/20 rounded-lg px-4 py-3">
